/**
 * `tad plugin --profile <name> <args...>` — profile plugin management as a
 ...
 * @param cwd - the directory `tad` was invoked from.
...
/**
 * Run one `tad plugin` invocation: init if needed, forward to pnpm, reconcile.
