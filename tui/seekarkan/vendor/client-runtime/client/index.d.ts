...
/** Surface startup policy; business state and selection still live in the Runtime. */
export interface ClientRuntimeConfig {
    /** Follow the persisted/recent Workspace automatically (Web default). */
 ...
 */
export declare function apply(ctx: Context, config?: ClientRuntimeConfig): void;
