...
/** Performance totals derived from one completed Turn's Harness events. */
export interface TurnTailStatistics {
...
/** Provider-reported token buckets accumulated inside one completed Turn. */
export interface TurnTailUsage {
...
export interface TurnTailChatData {
    ...
    /** Complete when this Client version observed the Turn lifecycle events. */
    readonly statistics?: TurnTailStatistics;
    /** Absent when the provider reported no valid usage sample for this Turn. */
    readonly usage?: TurnTailUsage;
}
/**
